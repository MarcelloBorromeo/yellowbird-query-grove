        ...
        <div className={cn(
          ...
          {visibleSuggestions.map((suggestion, index) => (
            <button
              ...
              className="text-xs bg-secondary hover:bg-secondary/80 text-secondary-foreground rounded-full px-3 py-1.5 transition-all hover:shadow-sm animate-fade-in"
            >
              {suggestion}
            </button>
          ))}
